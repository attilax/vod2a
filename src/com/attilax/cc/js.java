...
public class js {
	...
	private final String findTablePaichuStr = "银行记账日";
	private final String findTableKeyword = "利息";
	private final String accDay = "10";
	...
	public static void main(String[] args) throws IOException {
		...
		String path = "c:\\jsb.eml";path="c:\\ccx\\cc cb\\中信银行信用卡电子账单(1).eml";
		js c=new js();
 ...
 */
	...
	//	System.out.println("f");
		...
		for (Element e : trs) {
			...
			if (n == 1)
				continue;	
			if(e.toString().contains("主卡：艾龙(USD交易)"))
				continue;
			if(e.toString().contains("支付宝还款"))
				continue;
			if(e.toString().contains("自动购汇"))
				continue;
			
			
			
			Elements tds = getItemTds(e);
	...
	private Elements getItemTds(Element e) {
