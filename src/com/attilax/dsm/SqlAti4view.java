...
//	 */
//	public SqlAti4view setCls(Class<?> cls) {
//		this.cls = cls;
//		return this;
//	}
//	/**
...
//	 */
//	public SqlAti4view setReqMap(Map reqMap) {
...
//	 * @param fld
//	 * @return */
//	public SqlAti4view addSelectItem(Field fld) {
...
//	 * @param fld
//	 * @return */
//	private String getOorderbyitemStr(String  colName) {
...
//	 * @param fld
//	 * @return */
//	public SqlAti4view addGroupByItem(Field fld) {
...
//	 * 
//	 * @param fld */
//	@SuppressWarnings("all") public SqlAti4view addWhereExp(Field fld) {
...
//	private List getExprs(Field fld, String op, Map valMap) {
//		String colName = CountX.getColumnName( fld.getName(),this.cls);
