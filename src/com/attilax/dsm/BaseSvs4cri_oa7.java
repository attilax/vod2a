 ...
 *@since  o9n 4_9_i$
 */
public class BaseSvs4cri_oa7 extends BaseSvs{
...
//	o9o();
	...
	//	 Map m=Mapx.$().add("createTime", "2014-09-22").toMap();	 Class  cls = GvDownloadRecord.class;
		...
		List li=new BaseSvs4cri_oa7(). findByPropertyss(m,cls);
	 	 core.print_wzFmt(li);
	...
	private static void o9o() {
		//	 Map m=Mapx.$().add("", value)
				Criteria c = new BaseSvs4cri_oa7(). getSession().createCriteria(GvPlayRecord.class);
		...
		public List findByPropertyss(Map QueryPropertyssMap,Class<?> cls) {
			...
			for (Field fld : flds) {
				try {
					...
					SqlAti_Criteria_pubCheckover sql=new SqlAti_Criteria_pubCheckover();
...
//				return false;
			...
			String uifld=Dsmx.getUifld(fld);
		Object oriVal=queryPropertyssMap.get(uifld);
		 ...
		 */
		public BaseSvs4cri_oa7 setSaveObjClass(Class<?> saveObjClass) {
