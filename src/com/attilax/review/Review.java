 ...
 */
@Entity
@Table(name = "review", schema = "dbo", catalog = "gialweixin")
@DataTransferObject 
public class Review implements java.io.Serializable {
	...
	/** minimal constructor */
	public Review(Integer targetid, String targettype) {
		this.targetid = targetid;
		this.targettype = targettype;
	}

	/** full constructor */
	public Review(Integer targetid, String targettype, Integer state,
