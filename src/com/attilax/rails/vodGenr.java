 ...
 *@since  o79 j448$
 */
public class vodGenr extends FreeMarkertUtil {
...
//		}
	...
	private static void geneEditPage(String tits) {
		...
		analysisTemplate(Tmpltpath, "temp_edit.jsp", "utf-8", rootMap, geneFile);
	...
	private static void geneListPage(final String[] tits_a) {
		...
		analysisTemplate(Tmpltpath, "templete_list.htm", "utf-8", rootMap, modPath + listPagePath);
