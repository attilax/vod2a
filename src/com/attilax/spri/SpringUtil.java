		...
		if(applicationContext==null)
		{
		 ...
		 //	applicationContext = new ClassPathXmlApplicationContext("applicationContext-atti.xml");
			...
			String p=pathx.classPath()+"/";
			 core.log("--o5d path:"+p);
			 //path:/d:/workspace/gial/WebRoot/WEB-INF/classes/
			   String[] locations = {p+"applicationContext-actions.xml",p+ "applicationContext-common.xml",p+ "applicationContext-daos.xml",p+"applicationContext-services.xml",p+"applicationContext-zhoujb.xml"};
