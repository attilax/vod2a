 ...
 * @since 1.0
 */
public abstract class ZLibUtils2 {
	...
	public static void main(String[] args) throws  Exception  {
		...
		byte[] bytes_kmprsed=compress(bytes);
 
		String Str_kmprsed= new String(bytes_kmprsed,charsetName);
		System.out.println(Str_kmprsed);
		 byte[] b=Str_kmprsed.getBytes(charsetName);
		 System.out.println("==="+decompress_iso8859(Str_kmprsed));
	}
	/**
