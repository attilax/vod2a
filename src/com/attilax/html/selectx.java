...
public class selectx {
	...
	public static String state_keep_str(String param, String curVal) {
		ServletRequest req = (ServletRequest) HttpContext.Current.get().Request
				.get();
		if (req.getParameter(param) != null)
			if (req.getParameter(param).equals(curVal))
