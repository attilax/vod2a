 ...
 * @since Aug 30, 2014 7:30:12 AM$
 */
public class MultidatasCycleQueueImp<EE> extends GvDownloadTaskSvs<EE> implements
		CycleQueue< EE> {
	...
	//	dbx.session=sess;
		nx.$(1).times(new Closure() {
			...
			public void execute(Object arg0) {
				...
				MultidatasCycleQueueImp<GvDownloadTask> q = new MultidatasCycleQueueImp<GvDownloadTask>();
				q.dbx.session = sess;
				// q.iniCursor();
