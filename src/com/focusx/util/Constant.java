...
public class Constant {
	...
	public final static String uploadPathHtml = "D:\\gial\\html.war\\news";//生成html文件的存放路径
	
	public final static String uploadPathImage = "D:\\gial\\image.war\\news\\cover";//上传封面图片的存放路径
	
	public final static String uploadPathCode = "D:\\gial\\image.war\\code";//生成二维码的存放路径
	
	public final static String uploadPathHtmlImage = "D:\\gial\\image.war\\news";//正文中上传的图片的存放路径(完整路径后面有html文件夹)
	
	public final static String uploadPathDraw = "D:\\gial\\image.war\\message";//购物小票存放路径
	 ...
	 * 播放方式 普通
	 */
	public final static int PUBLISHTYPE_GENERAL = 1;
	/**
	 * 播放方式 插播
	 */
	public final static int PUBLISHTYPE_SPOTS = 2;
	 ...
	 * 不可操作
	 */
	public final static String RESULT_NONE = "none";
