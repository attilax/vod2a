...
public class TMbGroup  implements java.io.Serializable {
    ...
    // Fields    
     ...
     @Transient
     public TMbGroup getParentGrp() {
		return parentGrp;
	}


	public void setParentGrp(TMbGroup parentGrp) {
		this.parentGrp = parentGrp;
	}

	   @Transient
	public TMbGroup getGradParentGrp() {
		return gradParentGrp;
	}


	public void setGradParentGrp(TMbGroup gradParentGrp) {
		this.gradParentGrp = gradParentGrp;
	}


	TMbGroup parentGrp;
     TMbGroup gradParentGrp;
//     private Integer groupidParent;// 主键ID
//     private String groupnameParent;// 分组名称
//     private Integer groupidGradParent;// 主键ID
//     private String groupnameGradParent;// 分组名称
