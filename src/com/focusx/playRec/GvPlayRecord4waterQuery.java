...
public class GvPlayRecord4waterQuery  implements java.io.Serializable {
...
@Conditional
     ...
     @Conditional(displayType=displayType.rang) @GroupByDate 
     @NoFilt @NoFilt4condQuery
...
//jeig condit only 4 count query
    ...
    /** default constructor */
    public GvPlayRecord4waterQuery() {
    }

    
    /** full constructor */
    public GvPlayRecord4waterQuery(Integer screen, Timestamp playTime, Integer publishType, Integer materialId, Integer equipmentId) {
        this.screen = screen;
    ...
    @Transient
	public Integer getPrgrm_id() {
		return prgrm_id;
	}


	public void setPrgrm_id(Integer prgrm_id) {
		this.prgrm_id = prgrm_id;
	}

    @Transient
	public String getPrgrm_str() {
		return prgrm_str;
	}


	public void setPrgrm_str(String prgrm_str) {
		this.prgrm_str = prgrm_str;
	}
