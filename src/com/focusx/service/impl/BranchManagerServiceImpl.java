...
public class BranchManagerServiceImpl implements BranchManagerService {
	...
	public List<TMbGroup> getGroups(Pager page,Map<String, Object> data) {
		List groups = branchManagerDao.getGroups(page,data);
		page.setData(groups);
	...
	public List<TMbGroup> getGroupsToPublish(Pager page,
			Map<String, Integer> data) {
		List groups = branchManagerDao.getGroupsToPublish(data);
		page.setData(groups);
	...
	public List<TMbGroup> getAllOneGroup(Pager page,
			Map<String, Object> data) {
		List<TMbGroup> groups = branchManagerDao.getAllOneGroup(data,page);
		page.setData(groups);
	...
	public List<TMbGroup> getGroups() {
		...
		return branchManagerDao.getGroups();
	}
}
