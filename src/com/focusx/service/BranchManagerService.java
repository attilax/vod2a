...
public interface BranchManagerService {
	 ...
	 */
	public List<TMbGroup> getGroups(Pager pager, Map<String, Object> data);
	 ...
	 *  @param data 查询参数
	 */
	public List<TMbGroup> getGroupsToPublish(Pager pager, Map<String, Integer> data);
	 ...
	 *  @return List<TMbGroup> 分组信息集合
	 */
	public List<TMbGroup> getAllOneGroup(Pager page,Map<String, Object> data);
