...
@Entity @Table(name = "gv_download_record", schema = "", catalog = "") public class GvDownloadRecord implements java.io.Serializable {
	...
	/** default constructor */
	public GvDownloadRecord() {}

	/** full constructor */
	public GvDownloadRecord(Integer downloadFlag, Timestamp downloadOverTime, Integer programmeId, Integer materialId, Integer equipmentId, String sjFileName) {
